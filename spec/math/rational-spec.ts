...
describe("Rational", ()=> {
  ...
  it("num", ()=> {
    expect(Rational.num(0n).toString()).toEqual('0');
    expect(Rational.num(1n).toString()).toEqual('1');
    expect(Rational.num(123456789n).toString()).toEqual('123456789');
    expect(Rational.num(-2147483647n).toString()).toEqual('-2147483647');
    expect(Rational.num(36n, -1024n).toString()).toEqual('-9/256');
  });
  ...
  it("inv", ()=> {
    expect(Rational.num(2n, 3n).inv().toString()).toEqual('3/2');
    expect(Rational.num(-6n, 10n).inv().toString()).toEqual('-5/3');
  ...
  it("basic", ()=> {
    ...
    expect(a.pow(2n).toString()).toEqual('4/9');
    ...
    expect(a.neg().pow(2n).toString()).toEqual('4/9');
  });
