...
export class StringUtil {
   ...
   * @return {string}
   */
  public static random(len: number, optFilter: number = StringUtil.Types.LOWER | StringUtil.Types.UPPER | StringUtil.Types.DIGITS): string {
    let letter = '';
   ...
   * @return {string}
   */
  public static reverseLine(s: string, br = '\n'): string {
